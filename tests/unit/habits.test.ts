...
describe('toggleHabitCompletion', () => {
  ...
  it('does not return duplicate completion dates', () => {
    // If the input somehow had duplicates, toggle should ideally clean them or at least not add more
    const habitWithDuplicate = { ...mockHabit, completions: ['2024-01-01', '2024-01-01'] };
