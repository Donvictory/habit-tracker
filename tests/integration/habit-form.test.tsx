...
describe('habit form', () => {
  ...
  it('edits an existing habit and preserves immutable fields', async () => {
    saveHabits([{ 
      id: 'h1', userId: 'user1', name: 'Old Name', description: '', 
      frequency: 'daily', createdAt: '2024-01-01', completions: [] 
    }]);
  ...
  it('deletes a habit only after explicit confirmation', async () => {
    saveHabits([{ 
      id: 'h1', userId: 'user1', name: 'Delete Me', description: '', 
      frequency: 'daily', createdAt: '2024-01-01', completions: [] 
    }]);
  ...
  it('toggles completion and updates the streak display', async () => {
    saveHabits([{ 
      id: 'h1', userId: 'user1', name: 'Streak Habit', description: '', 
      frequency: 'daily', createdAt: '2024-01-01', completions: [] 
    }]);
